...
\begin{table}[h]
	...
	\textbf{\textit{Core drive}} & \textbf{Valor} \\ \hline
		Significado épico e chamado &  1 \\ \hline
		Desenvolvimento e conquista  &  2\\ \hline
		Empoderamento e feedback  &  3 \\ \hline
		Propriedade e posse  &  4 \\ \hline
		Influência e relacionamento social  &  5 \\ \hline
		Escassez e impaciência  &  6 \\ \hline
		Imprevisibilidade e curiosidade  &  7 \\ \hline
		Prevenção e perda  &  8 \\ \hline
	\end{tabular}%
	}
