...
\subsection{Diferenciais propostos}

Nas seções e subseções anteriores foram apresentadas tecnologias com características semelhantes à proposta deste trabalho, porém
algumas características como: materiais/conteúdo de estudo, escolha de personagens temáticos, disputas e desafios entre os jogadores, 
narrativa falada e contextualizada, músicas e sons temáticos entre outras características de jogos que são atraentes aos
usuários, não estão presentes nestas ferramentas e planeja-se desenvolver estas características.
