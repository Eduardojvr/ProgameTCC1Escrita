...
\subsection{Elementos motivacionais: Octógono}
...
\subsubsection{Divisão dos motivadores de acordo com sua natureza}
...
\subsubsection{Gamificação \textit{White Hat} e \textit{Black Hat}}
...
são conhecidos como \textit{"Black hat}.
...
\section{Ferramentas gamificadas existentes}
